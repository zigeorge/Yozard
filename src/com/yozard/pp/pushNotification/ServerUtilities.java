package com.yozard.pp.pushNotification;

import static com.yozard.pp.pushNotification.CommonUtilities.TAG;
...
public final class ServerUtilities {
	...
	static String base_url, auth_token;
	...
	public static void register(final Context context, String email,
			final String regId, String user_id) {
	...
	public static void unregister(final Context context, final String regId,
			final String email, String user_id) {
