...
//
//public class MenusAdapter extends ArrayAdapter<Heading> {
//
//	Context con;
...
//	// Offer offer;
//
//	public MenusAdapter(Context context, int resource, Vector<Heading> headings) {
...
//		TextView tvHeading, tvSubHeading, tvFoodName, tvDescription, tvPrice;
//		ListView lvExtras;
//	}
//
//	@Override
...
//			holder.tvSubHeading = (TextView) convertView
//					.findViewById(R.id.tvSubHeading);
//			holder.tvDescription = (TextView) convertView
//					.findViewById(R.id.tvDescription);
//			holder.tvFoodName = (TextView) convertView
//					.findViewById(R.id.tvFoodName);
//			holder.tvPrice = (TextView) convertView
//					.findViewById(R.id.tvPrice);
//			holder.lvExtras = (ListView) convertView
//					.findViewById(R.id.lvExtras);
